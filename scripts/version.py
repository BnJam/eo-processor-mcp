#!/usr/bin/env python3
"""Version management script for EO Processor MCP Server.

This script helps maintain version consistency across:
- pyproject.toml
- eo_processor_mcp/__init__.py
...
def update_init_version(new_version: str) -> None:
    """Update version in eo_processor_mcp/__init__.py."""
    init_path = Path("eo_processor_mcp/__init__.py")
    ...
    print(f"Updated eo_processor_mcp/__init__.py version to {new_version}")
...
def main():
    """Main entry point."""
    parser = argparse.ArgumentParser(description="Manage EO Processor MCP Server version")
    parser.add_argument(
        "action",
